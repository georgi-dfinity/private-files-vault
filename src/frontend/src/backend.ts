...
export class Backend implements backendInterface {
    ...
    async addFileMetadata(arg0: string, arg1: string, arg2: bigint, arg3: string, arg4: string): Promise<FileMetadata> {
        if (this.processError) {
            try {
                const result = await this.actor.addFileMetadata(arg0, arg1, arg2, arg3, arg4);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async adminListAllFiles(): Promise<Array<FileMetadata>> {
        if (this.processError) {
            try {
                const result = await this.actor.adminListAllFiles();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async renameFile(arg0: string, arg1: string): Promise<FileMetadata> {
        if (this.processError) {
            try {
